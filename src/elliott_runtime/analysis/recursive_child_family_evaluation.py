...
_SCOPE = MappingProxyType({
    RequiredInternalShape.MOTIVE_FIVE_FAMILY_REQUIRED: (
        ...
        ("LEADING_DIAGONAL",),
        (
            "NORMAL_IMPULSE_PARTIAL_P004_EXECUTABLE_SCOPE_AVAILABLE_VIA_SIDECAR",
            "NORMAL_IMPULSE_P005_UNRESOLVED",
            "NORMAL_IMPULSE_P006_UNRESOLVED_CONFLICT",
            "LEADING_DIAGONAL_EXECUTION_UNAVAILABLE",
            "MOTIVE_FIVE_COVERAGE_IS_NOT_EXHAUSTIVE",
        ), "SOURCE_DEFINITION",
    ),
